...
function Card({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="card" className={cn('bg-card text-primary flex flex-col gap-4 rounded-md pb-6 shadow-sm', className)} {...props} />
}
...
function CardTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="card-title" className={cn('leading-none font-semibold text-left', className)} {...props} />
}
